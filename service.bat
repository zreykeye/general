...
set "GITHUB_VERSION_URL=https://raw.githubusercontent.com/zreykeye/general/refs/heads/main/.services/verisons.txt"
set "GITHUB_RELEASE_URL=https://github.com/zreykeye/general/releases/tag/"
set "GITHUB_DOWNLOAD_URL=https://github.com/zreykeye/general/releases/lasets/download/zapret.rar"
...
if !errorlevel!==0 (
    ...
    call :PrintRed "https://github.com/zreykeye/general/issues/2"
) else (
...
if !errorlevel!==0 (
    ...
    call :PrintRed "https://github.com/zreykeye/general/issues/1"
) else (
...
set "listFile=%~dp0lists\ipset-all.txt"
set "url=https://raw.githubusercontent.com/zreykeye/general/refs/heads/main/lists/ipset-all.txt"
...
if %errorLevel% neq 0 (
    ...
    echo Fix your PATH variable with instructions here https://github.com/zreykeye/general/issues/1
    pause
    exit /b 1
)
exit /b 0
